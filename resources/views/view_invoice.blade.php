                                        ...
                                        <form action="/contact/detail/update" method="post" id="form-1"
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <select name="type" id="unit" class="form-select form-select-solid"
                                                    ...
                                                    <option value="Ferbyansah">PT Palugada</option>
                                                </select>
                                                @error('Customer')
                                                    <h6 class="text-danger fw-normal">{{ $message }}</h6>
                                                @enderror
                                            ...
                                            <div class="fv-row mb-6">
                                                ...
                                                <input type="number" class="form-control form-control-solid"
                                                    id="customer-number" name="customer-number" value="2"
                                    ...
                                    <table id="example" class="table table-striped" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                @endphp
                                                    ...
                                                    <tr>
                                                        <td style="text-align:center">{{ $no++ }}</td>
                                                        <td><a href="/view-procure-to-pay">INV-00002</a></td>
                                                        <td><a href="#">PT. Palugada</a></td>
                                                        <td>Admin</td>
                                                        <td>Rp.1.000.000</td>                                                        
                                                        <td>Paid</td>
                                    ...
                                    <div class="tab-pane fade show active" id="kt_contact_information" role="tabpanel"
                                        ...
                                        <div class="row">                                    
                                            ...
                                            <div class="container">
                                                ...
                                                <!--begin::Input-->
                                                <input type="text" class="form-control form-control-solid"
                                                    id="customer-number" name="customer-number" value="Rp.2.775.000"
                                                    placeholder="" readonly />
                                                <!--end::Input-->
