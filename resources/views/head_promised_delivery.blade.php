    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Delivery To Promise
                    <!--begin::Separator-->
                ...
                <tbody>
                    ...
                    @endphp
                        <tr>
                            ...
                            <td><a href="/promised-delivery">DP-00001</a></td>
                            <td>Ferbyansah</td>
                        ...
                        <tr>
                            <td style="text-align:center">{{ $no++ }}</td>
                            <td><a href="/promised-delivery">DP-00002</a></td>
                            <td>Alexander</td>
                            <td>Finish Goods Polybag</td>
                            <td>7000</td>
                            <td>Admin</td>
                        ...
                        <tr>
                            <td style="text-align:center">{{ $no++ }}</td>
                            <td><a href="/promised-delivery">DP-00003</a></td>
                            <td>Baker</td>
                            <td>Sealed Cup</td>
                            <td>3000</td>
                            <td>Admin</td>
                        ...
                        <tr>
                            <td style="text-align:center">{{ $no++ }}</td>
                            <td><a href="/promised-delivery">DP-00004</a></td>
                            <td>Ferbyansah</td>
                            <td>Sealed Cup</td>
                            <td>23000</td>
                            <td>Admin</td>
                        ...
                        <tr>
                            <td style="text-align:center">{{ $no++ }}</td>
                            <td><a href="/promised-delivery">DP-00005</a></td>
                            <td>Alexander</td>
                            <td>Finish Goods Polybag</td>
                            <td>2000</td>
                            <td>Admin</td>
                        ...
                        <tr>
                            <td style="text-align:center">{{ $no++ }}</td>
                            <td><a href="/promised-delivery">DP-00006</a></td>
                            <td>Baker</td>
                            <td>Finish Goods Polybag</td>
                            <td>6700</td>
                            <td>Admin</td>
                        ...
                        <tr>
                            <td style="text-align:center">{{ $no++ }}</td>
                            <td><a href="/promised-delivery">DP-00007</a></td>
                            <td>Ahmad</td>
                            <td>Finish Goods Polybag</td>
                            <td>6700</td>
                            <td>Admin</td>
                        ...
                        <tr>
                            <td style="text-align:center">{{ $no++ }}</td>
                            <td><a href="/promised-delivery">DP-00008</a></td>
                            <td>Alexander</td>
                            <td>Finish Goods Polybag</td>
                            <td>10000</td>
                            <td>Admin</td>
                ...
                <div class="modal-body py-lg-6 px-lg-6">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <label class="fs-6 fw-bold form-label mt-3 required">
                            <span>No. Delivery To Promise</span>
                        </label>
                        <!--end::Label-->
                        <!--begin::Input-->
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="number" id="quantity" name="quantity" class="form-control form-control-solid" 
