    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Reture
                    <!--begin::Separator-->
                ...
                <tbody>
                    ...
                    @endphp
                        <tr>
                            ...
                            <td><a href="/view-reture">RTR-00001</a></td>
                        ...
                        <tr>
                            <td style="text-align:center">{{ $no++ }}</td>
                            <td><a href="/view-reture">RTR-00002</a></td>
                            <td><a href="#">{{ Faker\Factory::create()->company() }}</a></td>
                            <td>Admin</td>
                            <td>Production</td>
                            <td>3</td>
                        ...
                        <tr>
                            <td style="text-align:center">{{ $no++ }}</td>
                            <td><a href="/view-reture">RTR-00003</a></td>
                            <td><a href="#">{{ Faker\Factory::create()->company() }}</a></td>
                            <td>Admin</td>
                            <td>Production</td>
                            <td>1</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-lg-6 px-lg-6">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        value="{{ old('no-job-order') }}" placeholder="No. Reture" />
                        @error('no-job-order')
