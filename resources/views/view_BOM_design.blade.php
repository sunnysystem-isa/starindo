        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack justify-content-beetwen">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <div class="d-flex flex-row justify-content-beetwen">
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Finish Goods Polybag</h1>
                </div>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
                                    ...
                                    <form action="/contact/detail/update" method="post" id="form-1" onsubmit="return validateInputs(this)">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" id="full-name" name="full-name"
                                                class="form-control rounded-0 border-bottom-dashed border-top-0 border-left-0 border-right-0 p-0 required" value="FG-001"
                                                placeholder="" />
                                            @error('name-customer')
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text" class="form-control rounded-0 border-bottom-dashed border-top-0 border-left-0 border-right-0 p-0 " id="email" name="email"
                                                value="Finish Goods Polybag" placeholder="" />
                                            @error('email')
                                                <h6 class="text-danger">{{ $message }}eror</h6>
                                            @enderror
                                            <!--end::Input-->
