        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack justify-content-beetwen">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <div class="d-flex flex-row justify-content-beetwen">
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">WO-00001</h1>
                </div>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
                                    ...
                                    <form action="/contact/detail/update" method="post" id="form-1" onsubmit="return validateInputs(this)">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <label class="fs-6 fw-bold form-label mt-3 required">
                                                <span>No. Reture<i class="bi bi-lock-fill"></i></span>
                                            </label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" id="no-job-order" name="no-job-order" class="form-control form-control-solid" 
                                            value="WO-00001" placeholder="No. Job Order" readOnly/>
                                            @error('no-job-order')
                                ...
                                <div class="tab-pane fade show active" id="kt_contact_information" role="tabpanel" aria-labelledby="info-tab" tabindex="0">
                                        <div class="row fv-row">
                                            ...
                                            <div class="col-6">
                                                        ...
                                                        <option value="JO-00002">JO-00002</option>
                                                        <option value="JO-00003">JO-00003</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-6">
                                                    <br>
                                                    <br>
                                                    <a href="/view-procure-to-pay" target="_blank" class="btn btn-secondary btn-sm me-2">View</a>
                                                    </div>
                                            </div>    
                                            <hr>
                                            <!--Begin::Row-->
                                                ...
                                                <table id="example" class="table table-striped" style="width:100%">
                                                    ...
                                                    <tbody id="BOM">
                                                            <tr>
                                                                ...
                                                                <td><input type="text" id="nama-item" name="nama-item" class="form-control" value="Plastic Waste"></td>
                                                                <td><input id="quantity" oninput="rumus(this)" type="number" name="" class="form-control" value="58"></td>
